Nextpad (1.1.0):
* **Feature**: Support for public shared folders.
* **Feature**: Support for groupfolder plugin.
* **Enhancement**: Dialog modals are used when trying to access protected pads in public shared folders.
* **Fix**: The icons for the MIME-Types are displayed correctly.
